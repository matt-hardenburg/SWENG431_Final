function PrivateBroadcast()
{
  ...
  for(i = 0; i < BrowserItems.length; i++)
  {
    ...
    //Sets the text 'PrivateBroadcast' in the 'textboxChannelName' text editor.
    Aliases.browser.pageHome.formLogin.fieldsetEmailOrUsername.label.textboxChannelName.SetText("PrivateBroadcast");
    //Clicks the 'labelBroadcast' control.
    Aliases.browser.pageHome.formLogin.fieldsetEmailOrUsername.labelBroadcast.Click();
    //Simulates a left-button single click in a window or control as specified (relative position, shift keys).
    ...
    //Clicks the 'panelPrivatebroadcast' control.
    Aliases.browser.pageHome.navNavigation2.linkPrivate.panelPrivatebroadcast.Click();
    //Enters 'Admin message[Enter]' in the 'textareaMessagePrivatebroadcast' object.
    Aliases.browser.pagePrivatebroadcastSweng431fina.sectionStartOfConversation.footerThisRoomIsReadOnly.label.textareaMessagePrivatebroadcast.Keys("Admin message[Enter]");
    //Simulates a left-button single click in a window or control as specified (relative position, shift keys).
    Aliases.browser.pagePrivatebroadcastSweng431fina.navNavigation.buttonUserMenu.Click();
    //Clicks the 'panelLogout' control.
    Aliases.browser.pagePrivatebroadcastSweng431fina.navNavigation.buttonUserMenu.panelLogout.Click();
    ...
    aqObject.CheckProperty(Aliases.browser.pageHome.navNavigation2.linkPrivate, "ObjectLabel", cmpEqual, "PrivateBroadcast");
    //Clicks the 'panel3' control.
    Aliases.browser.pageHome.navNavigation2.linkPrivate.panel3.Click();
    //Checks whether the 'Enabled' property of the Aliases.browser.pagePrivatebroadcastSweng431fina.sectionStartOfConversation.footerThisRoomIsReadOnly.panelThisRoomIsReadOnly object equals True.
    aqObject.CheckProperty(Aliases.browser.pagePrivatebroadcastSweng431fina.sectionStartOfConversation.footerThisRoomIsReadOnly.panelThisRoomIsReadOnly, "Enabled", cmpEqual, true);
    //Checks whether the 'contentText' property of the Aliases.browser.pagePrivatebroadcastSweng431fina.sectionStartOfConversation.footerThisRoomIsReadOnly.panelThisRoomIsReadOnly object equals 'This room is read only'.
    aqObject.CheckProperty(Aliases.browser.pagePrivatebroadcastSweng431fina.sectionStartOfConversation.footerThisRoomIsReadOnly.panelThisRoomIsReadOnly, "contentText", cmpEqual, "This room is read only");
    //Checks whether the 'contentText' property of the Aliases.browser.pagePrivatebroadcastSweng431fina.sectionStartOfConversation.textnodeMessageList.buttonReply object equals 'Reply'.
    aqObject.CheckProperty(Aliases.browser.pagePrivatebroadcastSweng431fina.sectionStartOfConversation.textnodeMessageList.buttonReply, "contentText", cmpEqual, "Reply");
    //Simulates a left-button single click in a window or control as specified (relative position, shift keys).
